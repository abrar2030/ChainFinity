...
import { formatAddress, formatNumber, formatDate } from '../../utils/formatters';
        ...
        return (
          <Card key={proposal.id} className="overflow-hidden">
            <div className="flex items-center p-1">
              <div className={`w-2 h-full ${getStatusColor(proposal.status)}`}></div>
              ...
              <div className="space-y-3 mb-6">
                <div>
                  <div className="flex justify-between mb-1">
                    ...
                    <span className="text-xs">{formatNumber(proposal.forVotes)}</span>
                  </div>
                ...
                <div>
                  <div className="flex justify-between mb-1">
                    ...
                    <span className="text-xs">{formatNumber(proposal.againstVotes)}</span>
                  </div>
                ...
                <div>
                  <div className="flex justify-between mb-1">
                    ...
                    <span className="text-xs">{formatNumber(proposal.abstainVotes)}</span>
                  </div>
