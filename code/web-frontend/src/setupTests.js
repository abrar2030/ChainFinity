...
global.IntersectionObserver = class IntersectionObserver {
  ...
  observe(target) { /* console.log('IntersectionObserver observe'); */ return null; }
  unobserve(target) { /* console.log('IntersectionObserver unobserve'); */ return null; }
  disconnect() { /* console.log('IntersectionObserver disconnect'); */ return null; }
};
