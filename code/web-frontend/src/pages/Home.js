...
const OutlinedButton = styled(Button)(({ theme }) => ({
    ...
    '&:hover': {
        backgroundColor:
            theme.palette.mode === 'light' ? 'rgba(58, 54, 224, 0.08)' : 'rgba(108, 99, 255, 0.08)',
    },
}));
                    ...
                    >
                        <motion.div variants={itemVariants}>
                            <Box sx={{ textAlign: 'center', mb: 6 }}>
                                ...
                                >
                                    Everything you need to track and manage your crypto portfolio in
                                    one place
                                </Typography>
                            </Box>
                        </motion.div>
                                    ...
                                    <FeatureCard>
                                        <CardContent sx={{ p: 3, textAlign: 'center' }}>
                                            ...
                                            <Typography variant="body1" color="text.secondary">
                                                Track your assets across multiple blockchains
                                                including Ethereum, Polygon, Binance Smart Chain,
                                                and more.
                                            </Typography>
                                        </CardContent>
                                    </FeatureCard>
                                ...
                                <motion.div variants={itemVariants}>
                                    <FeatureCard>
                                        <CardContent sx={{ p: 3, textAlign: 'center' }}>
                                            ...
                                            <Typography variant="body1" color="text.secondary">
                                                Get detailed insights into your portfolio
                                                performance with advanced analytics and
                                                visualization tools.
                                            </Typography>
                                        </CardContent>
                                    </FeatureCard>
                                    ...
                                    <FeatureCard>
                                        <CardContent sx={{ p: 3, textAlign: 'center' }}>
                                            ...
                                            <Typography variant="body1" color="text.secondary">
                                                ...
                                                across all connected wallets and exchanges.
                                            </Typography>
                                        </CardContent>
                                    </FeatureCard>
                                </motion.div>
                                ...
                                <motion.div variants={itemVariants}>
                                    <FeatureCard>
                                        <CardContent sx={{ p: 3, textAlign: 'center' }}>
                                            ...
                                            <Typography variant="body1" color="text.secondary">
                                                Your security is our priority. We use read-only API
                                                keys and never store your private keys.
                                            </Typography>
                                        </CardContent>
                                    </FeatureCard>
                                </motion.div>
                                ...
                                <motion.div variants={itemVariants}>
                                    <FeatureCard>
                                        <CardContent sx={{ p: 3, textAlign: 'center' }}>
                                            ...
                                            <Typography variant="body1" color="text.secondary">
                                                Get real-time price updates and portfolio valuation
                                                with our high-performance data feeds.
                                            </Typography>
                                        </CardContent>
                                    </FeatureCard>
                                </motion.div>
                                ...
                                <motion.div variants={itemVariants}>
                                    <FeatureCard>
                                        <CardContent sx={{ p: 3, textAlign: 'center' }}>
                                            ...
                                            <Typography variant="body1" color="text.secondary">
                                                Track your DeFi positions, liquidity pools, and
                                                staking rewards all in one dashboard.
                                            </Typography>
                                        </CardContent>
                                    </FeatureCard>
                                </motion.div>
                        ...
                        <Grid container spacing={4}>
                                ...
                                <motion.div variants={itemVariants}>
                                    ...
                                    >
                                        <Typography variant="body1" paragraph>
                                            ...
                                            crypto investments. The multi-chain support and
                                            real-time data are game-changers for anyone serious
                            ...
                            <Grid item xs={12} md={4}>
                                <motion.div variants={itemVariants}>
                                    ...
                                    >
                                        <Typography variant="body1" paragraph>
                                            "The analytics and visualization tools in ChainFinity
                                            are unmatched. I can finally understand my portfolio
