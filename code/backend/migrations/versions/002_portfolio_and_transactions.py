...
def upgrade():
    ...
    op.create_table('portfolios',
        ...
        sa.Column('portfolio_type', sa.Enum('personal', 'managed', 'algorithmic', name='portfoliotype'), nullable=False, default='personal'),
        ...
        sa.Column('auto_rebalance_enabled', sa.Boolean(), nullable=False, default=False),
    ...
    op.create_table('portfolio_assets',
        ...
        sa.Column('asset_type', sa.Enum('cryptocurrency', 'token', 'nft', 'defi', name='assettype'), nullable=False),
    ...
    op.create_index('idx_portfolio_asset_portfolio_id', 'portfolio_assets', ['portfolio_id'])
    ...
    op.create_unique_constraint('uq_portfolio_asset', 'portfolio_assets', ['portfolio_id', 'asset_symbol', 'chain_id'])
    ...
    op.create_table('transactions',
        ...
        sa.Column('transaction_type', sa.Enum('buy', 'sell', 'transfer_in', 'transfer_out', 'swap', 'stake', 'unstake', 'claim', 'deposit', 'withdraw', name='transactiontype'), nullable=False),
        sa.Column('status', sa.Enum('pending', 'confirmed', 'failed', 'cancelled', name='transactionstatus'), nullable=False, default='pending'),
        sa.Column('chain_id', sa.Integer(), nullable=False),
        ...
        sa.Column('compliance_status', sa.Enum('pending', 'approved', 'flagged', 'blocked', name='compliancestatus'), nullable=False, default='pending'),
    ...
    op.create_index('idx_blockchain_network_chain_id', 'blockchain_networks', ['chain_id'])
    op.create_index('idx_blockchain_network_active', 'blockchain_networks', ['is_active'])
