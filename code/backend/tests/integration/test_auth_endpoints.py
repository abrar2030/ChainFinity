...
class TestAuthEndpoints:
    ...
    @pytest.mark.asyncio
    async def test_change_password_invalid_current(self, async_client: AsyncClient, test_user, auth_headers):
