...
class TestAuthService:
    ...
    @pytest.mark.asyncio
    async def test_authenticate_user_invalid_password(self, auth_service, db_session, test_user):
    ...
    @pytest.mark.asyncio
    async def test_authenticate_user_locked_account(self, auth_service, db_session, test_user):
    ...
    async def test_register_user_success(self, auth_service, db_session):
        ...
        assert user.primary_wallet_address == "0x1234567890abcdef1234567890abcdef12345678"
    
    @pytest.mark.asyncio
    async def test_register_user_duplicate_email(self, auth_service, db_session, test_user):
    ...
    async def test_change_password_success(self, auth_service, db_session, test_user):
        ...
        assert password_service.verify_password("NewPassword123!", test_user.hashed_password)
        assert not password_service.verify_password("testpassword", test_user.hashed_password)
    
    @pytest.mark.asyncio
    async def test_change_password_invalid_current(self, auth_service, db_session, test_user):
