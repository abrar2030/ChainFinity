...
class RiskAlert(BaseModel, TimestampMixin, AuditMixin):
    ...
    def is_open(self) -> bool:
        ...
        return self.status in [AlertStatus.OPEN, AlertStatus.ACKNOWLEDGED, AlertStatus.INVESTIGATING]
    ...
    def resolve(self, resolved_by: str, notes: str = None, is_false_positive: bool = False) -> None:
        """Resolve the alert"""
        self.status = AlertStatus.FALSE_POSITIVE if is_false_positive else AlertStatus.RESOLVED
