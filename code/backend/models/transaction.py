...
class Transaction(BaseModel, TimestampMixin, AuditMixin):
    ...
    tx_hash = Column(String(66), nullable=True, unique=True, index=True)  # Ethereum tx hash
    ...
    amount_usd = Column(Numeric(20, 8), nullable=True)  # USD value at time of transaction
