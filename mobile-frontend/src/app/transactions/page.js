      ...
      <Container maxWidth="lg">
        ...
        >
          ...
          <motion.div variants={itemVariants}>
            <Box sx={{ mb: { xs: 3, md: 4 }, display: 'flex', flexDirection: { xs: 'column', sm: 'row' }, justifyContent: 'space-between', alignItems: { xs: 'flex-start', sm: 'center' } }}>
              <Box>
                <Typography variant={{ xs: "h5", md: "h4" }} component="h1" fontWeight={700}>
                  Transactions
                </Typography>
                ...
                <Table>
                  <TableHead>
                    <TableRow>
                      ...
                      <StyledTableCell sx={{ display: { xs: 'none', md: 'table-cell' } }}>Value</StyledTableCell>
                      <StyledTableCell>Date & Time</StyledTableCell>
                      <StyledTableCell sx={{ display: { xs: 'none', md: 'table-cell' } }}>Network</StyledTableCell>
                    ...
                    {paginatedTransactions.length > 0 ? (
                      paginatedTransactions.map((transaction) => (
                        <StyledTableRow key={transaction.id}>
                          ...
                          <StyledTableCell sx={{ display: { xs: 'none', md: 'table-cell' } }}>{transaction.value}</StyledTableCell>
                          <StyledTableCell>
